 ...
 * @author IronSid
 * @version 1.0
 * @since 2023-03-18 21:03:22 
 */
public class SplitTwoStringsToMakePalindromeSolution {
static
//leetcode submit region begin(Prohibit modification and deletion)
class Solution {
    public boolean checkPalindromeFormation(String as, String bs) {
    ...
    boolean isPalindrome(int start, int end, char[] c) {
