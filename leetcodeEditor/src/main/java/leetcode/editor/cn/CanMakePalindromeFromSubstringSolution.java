 ...
 * @author IronSid
 * @version 1.0
 * @since 2023-06-15 23:38:31 
 */
public class CanMakePalindromeFromSubstringSolution {
static
...
class Solution {
    public List<Boolean> canMakePaliQueries(String s, int[][] queries) {
        ...
        for (int[] query : queries) {
            ...
            // 计算有多少字母的频率是奇数
            int remain = Integer.bitCount(p[r + 1] ^ p[l]);
            // 替换其中一半的字母，该子串可以重排成回文
            res[j++] = remain / 2 <= k;
        }
