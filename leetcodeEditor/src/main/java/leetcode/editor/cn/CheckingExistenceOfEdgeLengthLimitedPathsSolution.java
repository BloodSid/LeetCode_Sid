 ...
 * @author IronSid
 * @version 1.0
 * @since 2022-12-14 02:41:39 
 */
public class CheckingExistenceOfEdgeLengthLimitedPathsSolution {
static
...
class Solution {
    ...
    public boolean[] distanceLimitedPathsExist(int n, int[][] edgeList, int[][] queries) {
        ...
        Integer[] idx = IntStream.range(0, queries.length).boxed().toArray(Integer[]::new);
        // 按边长上限递增排序
        Arrays.sort(idx, (o1, o2) -> queries[o1][2] - queries[o2][2]);
