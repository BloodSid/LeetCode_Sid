...
/**
 * EscapeALargeMazeSolution Tester.
 *
 * @author IronSid
 * @version 1.0
 * @since 01/12/2022
 */
public class EscapeALargeMazeSolutionTest {
    EscapeALargeMazeSolution.Solution solution = new EscapeALargeMazeSolution().new Solution();
    ...
    /**
     * Method: isEscapePossible(int[][] blocked, int[] source, int[] target)
     */
    @Test
    public void testIsEscapePossible() throws Exception {
        ...
        boolean actual = solution.isEscapePossible(blocked, source, target);
